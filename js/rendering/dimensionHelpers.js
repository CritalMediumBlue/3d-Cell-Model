...
/* 
    ...
    this.reticle.position.y = -0.01; // Slightly below the top to avoid z-fighting
...
/*     // Create RMSD shell (pink)
    ...
    this.reticleExpectedRMSD.position.y = 0.01; // Slightly above the top to avoid z-fighting
